...
Definition of the classes of all the agents and the objects (implemented as agents)
of a city traffic simulation where intersections are regulated by traffic lights
